using System;
//struct for copy instead of references
public struct PoseDescription
{
...
#region getters
	...
	//hack: figure out why structs shouldn't have constructors to make informed choice why not to do this
	public PoseDescription FakeConstructor()
	{
	...
	{
		data = new sbyte[DATA_SIZE];
		ByteTypeConverter.BytesToSbytes(_data_bytes).CopyTo(data, 0);
	}
	...
	{
		return $"Positions: Head({head_Position_x},{head_Position_y},{head_Position_z}), Left({hand_Position_Left_x},{hand_Position_Left_y},{hand_Position_Left_z}), Right({hand_Position_Right_x},{hand_Position_Right_y},{hand_Position_Right_z}) Rotations: Head({head_Rotation_x},{head_Rotation_y},{head_Rotation_z}, {head_Rotation_w}), Left({hand_Rotation_Left_x},{hand_Rotation_Left_x},{hand_Rotation_Left_x}, {hand_Rotation_Left_w}), Right({hand_Rotation_Right_x},{hand_Rotation_Right_y},{hand_Rotation_Right_z}, {hand_Rotation_Right_w})";
	}
}
